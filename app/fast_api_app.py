...
app.title = "excel-agent"
app.description = "API for interacting with the Agent excel-agent"
...
async def upload_file_endpoint(
    ...
    """Direct spreadsheet upload endpoint. Saves to gs://{bucket}/{user_id}/{filename}
    and flattens sheets into BigQuery ephemeral tables with a 2-hour TTL.
    """
    from app.ingestion import ingest_file, sanitize_user_id, upload_bytes_to_dropzone

    active_user = user_id or x_user_id or "default_user"
    user_slug = sanitize_user_id(active_user)
